...
def main():
    ...
    parser.add_argument(
            ...
            help="Float value representing similarity threshold below which files are no longer considered to be similar",
    ...
    for libname in liblist:
        ...
        print('[{:04d}/{:04d},lj={:04d},jn={:04d},nj={:04d},jj={:04d},ll={:04d}] Processing {}'.format(
            filenum,
            numfiles,
        ...
        if jsondict == newjson:
            ...
            log_printer.log('ERROR', 'comparison-json:  {} | {}'.format('jsondict != newjson', libname))
        ...
        similarity = diff_files(in1, in2, print_diff=False, return_similarity=True, similarity_method='quick')
        if similarity > args.lib_similarity_threshold:
            log_printer.log('INFO', ' comparison-lib: {} | {}'.format(similarity, libname))
        else:
            log_printer.log('ERROR', 'comparison-lib:  {} | {}'.format(similarity, libname))
